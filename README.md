So this is just a practice project for the roadmap.sh. Anyway for some fast intruction to run.
1. Input your API Key at the constructor of Weather Service in main
2. Run the main file
3. You can input the name of the location or the Zip Code (I believe zip code only work for US territory tho)
